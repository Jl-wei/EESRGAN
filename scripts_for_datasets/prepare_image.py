...
class PrepareImg():
    def __init__(self):
        self.up_scale = 4
        self.mod_scale = 4
        self.sourcedir = '/home/jlwei/datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS'
        self.savedir = '/home/jlwei/datasets/COWC/DetectionPatches_256x256/Potsdam_ISPRS'
